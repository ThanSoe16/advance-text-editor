      ...
      <div className="flex items-center gap-1 p-1 bg-white border border-gray-200 rounded-lg shadow-sm mb-4">
        <button
          ...
          className={`p-2 rounded hover:bg-gray-100 transition-colors ${
            editor.isActive("bold") ? "bg-gray-100 text-black font-semibold" : "text-gray-600"
          }`}
          title="Bold"
        >
        ...
        <button
          ...
          className={`p-2 rounded hover:bg-gray-100 transition-colors ${
            editor.isActive("strike") ? "bg-gray-100 text-black" : "text-gray-600"
          }`}
          title="Strikethrough"
        >
          <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
        ...
        <button
          ...
          className={`p-2 rounded hover:bg-gray-100 transition-colors ${
            editor.isActive("bulletList") ? "bg-gray-100 text-black" : "text-gray-600"
          }`}
          title="Bullet List"
        >
          <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
        ...
        <button
          ...
          className={`p-2 rounded hover:bg-gray-100 transition-colors ${
            editor.isActive("orderedList") ? "bg-gray-100 text-black" : "text-gray-600"
          }`}
          title="Numbered List"
        >
          <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
